...
public class GDMResultFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_gdmresult_cn, container, false);
    ...
    private void Init(){
        ...
        if(Float.compare(GDM_Prob, 0.5f) >= 0){
            // 设置检测结果文本、字体颜色
            msgText.setText(resources.getString(R.string.GDM_msg_cn));
            ...
            resultText.setText(resources.getString(R.string.GDM_cn));
        ...
        // 不患病
            ...
            // 设置检测结果文本、字体颜色
            msgText.setText(resources.getString(R.string.normal_msg_cn));
            ...
            resultText.setText(resources.getString(R.string.normal_cn));
